...
function GetDatasourceSetInfo
{
	...
	param(
		...
		[Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.IDatasource]
		$DatasourceInfo,
	...
	process 
	{
		$DataSourceSetInfo = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.DatasourceSet]::new()
...
function GetDatasourceInfo
{
	...
	{
		$manifest = LoadManifest -DatasourceType $DatasourceType.ToString()
		$DataSourceInfo = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.Datasource]::new()
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCanq27otVsG/8N
# IqZouaP4o+acwMicMEkIqX8ipNrMD6CCDXYwggX0MIID3KADAgECAhMzAAADTrU8
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAXldYrIQXCLmDBjIiWOJomP
# wuPH2nMPuVusXpLxC7v+MEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAqiHwMjzhsMigHiCHTeZbv0xcsyMG095t+pMmGlB0teu3nCp+j071fVrt
# V0Tb1qSRkottbXMbkYvOX5IY/dPbYPwzwSf3Z/dlA1JBQlGtV1GCqKsWVc9a5+Gb
# 9eqlUgrEp2RhQKZgQW4Q0kOFIgDkMURSCJh+dsmVVwoBC6pG/S9V0n5btiCuAMUW
# 4oYzH4JDHNw4x9RzBFGFuA7m7fpXBFvoZKmADcdjQvaxUNZKUftJohQJi9G6VNl2
# gjv8UEVnjPNve5qnQXoJBmyanRM9TKTneSzd+NsT+viJx1pvpq56ReCVHl2zQ/EX
# gD/32+EZaNJojCtHyCCW3COxutytKKGCF5cwgheTBgorBgEEAYI3AwMBMYIXgzCC
# F38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFSBgsq
# hkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCBlY41tk0tfX7vR5SvcJBUXRWBUQgjLvinjJ/CAFNRCQwIGZQPkOx5c
# GBMyMDIzMDkyMDA1NTAzNy43NTJaMASAAgH0oIHRpIHOMIHLMQswCQYDVQQGEwJV
...
# MC8GCSqGSIb3DQEJBDEiBCAS6vhUTWH9wHUljWFfwr/1NEwmhcB1r070ZG6l2rwT
# HTCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EILPpsLqeNS4NuYXE2VJlMuvQ
...
# nNtfZWb67InhK/+dXK8wDQYJKoZIhvcNAQELBQAEggIAYJJFcXUwveXo1tzc+iwq
# G7T4hEuBfozYmOTP7ts24iSRmaEPEudJrHlypYd1gCj5tzFrzQAit5n5p7DivIkP
# vNNucdaJRs8w1KPy+WgcCNCSymCrhk9Vf4k3TLKPFcbsLAXTO0wZISVtsjyct3T3
# xYARyfVHcjCgT1CSqVdD4SYomD8gvbsuvvFVxaopERww2r8uK0k5IUyy9SGvYojt
# fwiHUL5d+MlYFt77NGBiTy7fWDExdtxNHCYkb1oBrBNp6zE9UjB0/VKXcFLJbKN3
# 03nv9lcAEhA8aXlVsI+dnaDQVZKbrtLeNB86VKeU2VJZMqcimA/mbeHDjvRBMnCS
# kOxOkr18JAvE08Q2aIu1KGzzvqGX4zTIAQgb43ecei+P+Aml7aaK4m2nuuH+RA7V
# kwmEj/Gv7Cy3B3JvwO0XEC2S9WV88WW5VTDZNGUvMhbDymNKkzXf862/g148Y6NY
# AFf4cLz+epJW6gFkaSEQ40oyqOpRT0lf6Wj29jNOjlEcsxQewjsKf34X9MNAoLn/
# p6D8gE8DBQT2Aqv3X8qE4FAY9uHjPmtj38C2adziz0d2sEUAobb1L7KzNAiniiJh
# J7B5sKfevVUF9uAreOO1v+0ToPoLXVBYxc+U+6qfgESceZT9WKr9/gbbGwCAzDNI
# T1/Q0YXmBolKm3orB7IOTno=
