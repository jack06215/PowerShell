...
function Initialize-AzDataProtectionBackupInstance {
    ...
    process {
        ...
        $backupInstance = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.BackupInstance]::new()
        ...
        {            
            if($manifest.supportSecretStoreAuthentication -eq $true){
                ...
                $backupInstance.DatasourceAuthCredentials = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.SecretStoreBasedAuthCredentials]::new()
                $backupInstance.DatasourceAuthCredentials.ObjectType = "SecretStoreBasedAuthCredentials"
                $backupInstance.DatasourceAuthCredentials.SecretStoreResource =  [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.SecretStoreResource]::new()
        ...
        $backupInstanceResource = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.BackupInstanceResource]::new()
        ...
        {
            $operationalParam = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230501.AzureOperationalStoreParameters]::new()
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCVhtwv0HdKjQsq
# OdFknuW/Ezp8QrW1DeOaRDeekQB5VKCCDXYwggX0MIID3KADAgECAhMzAAADTrU8
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKcNfnZxCtF3JK4FSyVDafqw
# 3HNoovk18sG7AR0d0cdJMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAvydj6mi+ng9cLJuBWAbpZgsgdXdHIgKxpGvgebo0GL5quLpHaH+KWus8
# c2JYsuVJW8mfu79ZiwDVRKTsSliOuPPGm9Vj6vLQhwxBvz/23pcIjI9w1wf58XNg
# tWP+0tiqtdkt8mpX0lMgkbEP1xbiah7cKX5rWQcfFx7hZHQgFh0Yq6d/uK4krqfb
# rCcMCdRuwmQpQ4bLfp1sjtgIJhuMEyWBYDXDCeBptFm7MENqwhaQG6MA/huMbVj0
# h0nwRJi5bK6Cabu/WxaoiC74UPhImvkKfx7PEFqVHfwO0bxHftmubyrYPBa/wLs0
# Vl0pr04InY64QhxDyoxH0nnb0y6No6GCF5cwgheTBgorBgEEAYI3AwMBMYIXgzCC
# F38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFSBgsq
# hkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCBMOh/TwNrJHMZA04ydNqkkF4kCUqiRCwdbB5oOkNzp9gIGZQQYmkvG
# GBMyMDIzMDkyMDA1NTAzNC4xMzRaMASAAgH0oIHRpIHOMIHLMQswCQYDVQQGEwJV
...
# IFBDQSAyMDEwMA0GCSqGSIb3DQEBCwUAAgUA6LSFsjAiGA8yMDIzMDkxOTIwNDAx
# OFoYDzIwMjMwOTIwMjA0MDE4WjB3MD0GCisGAQQBhFkKBAExLzAtMAoCBQDotIWy
# AgEAMAoCAQACAjHXAgH/MAcCAQACAhNYMAoCBQDotdcyAgEAMDYGCisGAQQBhFkK
# BAIxKDAmMAwGCisGAQQBhFkKAwKgCjAIAgEAAgMHoSChCjAIAgEAAgMBhqAwDQYJ
# KoZIhvcNAQELBQADggEBAB1uxxmpTDy5FZQuk+7mK4+AlD43wpsMzC0xit4VBnML
# qwdOnw/Wf45usB8Fc9NBdzJvRgd+dp/rltrkPULeZhe7lRJY0XykB7kudaK62mpD
# dt8ZJaFo357+Sj5QQboLiU+cuDV3olcWbNzDFfa+T0YxGHhlqptkQd1YxJm1Z3LI
# bNUPIrPrBqvmjMTXzvayNsMvYLdEYKawq9jreHm5cJ61aFaoSiLzx0uEN6M6v60a
# A3pHw1Aei5oPsPXkwSkdg1iR/k2caUSwrHu4vEzkkpSY35WVOdUyzSjd2hwJcbMO
# nT6hWIqwAVFNq0pfks6esUR9RlPfQR37BGia9U9JS+8xggQNMIIECQIBATCBkzB8
...
# MC8GCSqGSIb3DQEJBDEiBCDTuhcWP2JGl0kSvyywpmaFSChQIkdRZPMu1xDSTsnt
# fzCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIJJm9OrE4O5PWA1KaFaztr9u
# P96rQgEn+tgGtY3xOqr1MIGYMIGApH4wfDELMAkGA1UEBhMCVVMxEzARBgNVBAgT
# Cldhc2hpbmd0b24xEDAOBgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jvc29m
# dCBDb3Jwb3JhdGlvbjEmMCQGA1UEAxMdTWljcm9zb2Z0IFRpbWUtU3RhbXAgUENB
# IDIwMTACEzMAAAHTHTKaFztAMHMAAQAAAdMwIgQg+iMRNBtTTZrs9h7henAomS1h
# 99WUAdH6bXxMFPprGTYwDQYJKoZIhvcNAQELBQAEggIALC1a42QYi5YlOQHAdfLK
# geA33rJMdzH4iBvQ8mMAtU69z1CP0cBUXTEerb3VQ0wCONjkcVizkeJjCD/dLDkd
# AqQVjS3C7ISaZBfpuyl2bFJ8kzZe9fie82RStQiiOyFHDvdyPiWRiX5EoNZIq5ag
# 53jSaLsDm6aSXBIDwV71IASK3EVrA35zPj08UsfWRHYOvv7f3ZhaGZDCzwykKktd
# jSvWFyb9wjU179XOqVa+Wh+rxzxmIhuMWWxNuv7gqgqLl6L13l3b9AE8GUZXgK63
# DlxRzufQNi0YGD3Vvm3BcY8dPCV5eDxUM+APE7hOYCZNneQT8o0uLipGX1yJiQQJ
# ZfXhZQGxq3g6d7cuNu8Nm/wBfEKdVYOt0yXsLKMwSb7rGUazbHiTwPRjLkwa+g7t
# zntmVi41pszVdxCwvelG96UrX/uBf2ruGmFhRKS7Fa1YmsvuVqFrryHDMsd4uV2S
# Tki4mh3LKP+YvEe9W6ZF5D9lbE33aZuuQV3Mu08JkIzSxgQbsw3IepPrrI9IQWMu
# 9Y50tqMEidDgxr9Kie+KFziErjF3fwG1zS8qjccS8tE4yBTGkgU74lzajsLvZ5GG
# 32zdh7IQVvmDQO6e/I9y3ppPCsEojvgdyWMGZG/aV1dtHMF8tCKf1ltmklkDrNmC
# 96OoIKMDrFsq9otbQEW6YWY=
